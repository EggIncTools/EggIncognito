...
namespace EggIncognito.Data.Migrations
{
    ...
    [Migration("20260916033718_AddForeignKeyIndexes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EggIncognito.Data.Models.DeviceIslandRow", b =>
                {
                    b.Property<string>("DeviceId")
                        .HasColumnType("text")
                        .HasColumnName("device_id");
                    ...
                    b.Property<string>("EggAccountId")
                        .HasColumnType("text")
                        .HasColumnName("egg_account_id");
            ...
            modelBuilder.Entity("EggIncognito.Data.Models.FeedDelivery", b =>
                {
                    b.HasOne("EggIncognito.Data.Models.FeedSubscription", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EggIncognito.Data.Models.ProtoProto", b =>
                {
                    b.HasOne("EggIncognito.Data.Models.ProtoVersion", null)
                        .WithMany()
                        .HasForeignKey("ProtoVersionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("EggIncognito.Data.Models.SiteThemePolicy", b =>
                {
                    b.HasOne("EggIncognito.Data.Models.UserTheme", null)
                        .WithMany()
                        .HasForeignKey("DefaultThemeId")
                        .OnDelete(DeleteBehavior.SetNull)
            ...
            modelBuilder.Entity("EggIncognito.Data.Models.SubjectTag", b =>
                {
                    b.HasOne("EggIncognito.Data.Models.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
